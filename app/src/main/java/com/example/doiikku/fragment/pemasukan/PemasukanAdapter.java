...
public class PemasukanAdapter extends RecyclerView.Adapter<PemasukanAdapter.ViewHolder> {
    ...
    public PemasukanAdapter(Context context, List<ModelDatabase> list, PemasukanAdapterCallback adapterCallback) {
    ...
    public void addData(List<ModelDatabase> pemasukans) {
        this.list = pemasukans;
